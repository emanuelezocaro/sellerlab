...
$description = 'Zalando, Farfetch, YOOX, Depop: guida completa ai marketplace di moda italiani con commissioni e requisiti di accesso.';
...
$og_description = 'Zalando, Farfetch, YOOX, Depop: guida completa ai marketplace di moda italiani con commissioni e requisiti di accesso.';
...
<div class="page-hero">
  <div class="page-hero-inner">
    ...
    <h1>Marketplace Fashion e Moda Italia 2026</h1>
    <p>Zalando, Farfetch, YOOX, Depop e altri.</p>
  </div>
</div>
...
<section class="section">
  <div class="section-inner">
    ...
    <div class="section-header" style="margin-bottom:32px;">
      <h2>Moda & Fashion: i canali di vendita</h2>
    </div>
    <div id="fashion">
