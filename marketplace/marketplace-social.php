...
$description = 'TikTok Shop, Instagram Shop: la guida al social commerce per venditori italiani. Commissioni, requisiti e strategie.';
$canonical = 'https://sellerlab.it/marketplace/marketplace-social.php';
$og_title = 'Social Commerce Italia 2026 | SellerLab';
$og_description = 'TikTok Shop, Instagram Shop: la guida al social commerce per venditori italiani. Commissioni, requisiti e strategie.';
...
<div class="page-hero">
  <div class="page-hero-inner">
    ...
    <h1>Social Commerce Italia 2026</h1>
    <p>TikTok Shop, Instagram Shop e social selling.</p>
  </div>
</div>
...
<section class="section">
  <div class="section-inner">
    ...
    <div class="section-header" style="margin-bottom:32px;">
      <h2>Vendere sui social: il social commerce</h2>
    </div>
    <div id="social">
